...
namespace BoligBlik.MVC.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            Input.User.EmailAddress = Input.Email;
            if (await CreateBackendUser(Input.User) == true)
            {
        ...
        private async Task<bool> CreateBackendUser(CreateUserViewModel User)
        {
            try
            {
                var userDTO = _mapper.Map<CreateUserDTO>(User);
                var result = await _userProxy.CreateUserAsync(userDTO);
                return result;
            }
            catch (Exception ex)
            {
